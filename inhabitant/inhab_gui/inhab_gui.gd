...
func _ready():
	var adjust_sizing = func():
		...
		var inv = $inventory
		inv.custom_minimum_size.y = new_size
...
func show_minimap(show_on_gui: bool = true): minimap.visible = show_on_gui
func show_markers(show_on_gui: bool = true): markers = show_on_gui
...
func show_compass(show_on_gui: bool = true): $top/displays/dials/compass.visible = show_on_gui
...
func show_clock(show_on_gui: bool = true): $top/displays/dials/clock.visible = show_on_gui
